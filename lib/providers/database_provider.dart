...
class DatabaseProvider with ChangeNotifier {
  ...
  Future<void> addParcelle(Parcelle p) async {
    await _db.addParcelle(p);
    await loadParcelles();
  }
  ...
  Future<void> addCellule(Cellule c) async {
    await _db.addCellule(c);
    await loadCellules();
  }
  ...
  Future<void> addChargement(Chargement c) async {
    await _db.addChargement(c);
  ...
  Future<void> loadSemis() async {
    _semis = await _db.getSemis();
    notifyListeners();
  }

  Future<void> addSemis(Semis s) async {
    await _db.addSemis(s);
    await loadSemis();
  }
  ...
  Future<void> addVariete(Variete v) async {
    await _db.addVariete(v);
    await loadVarietes();
  }
