    ...
    return Scaffold(
      ...
      body: Consumer<DatabaseProvider>(
        builder: (context, provider, child) {
          ...
          final annees = anneesSet..sort((a, b) => b.compareTo(a));
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        try {
                          ...
                          final chargement = Chargement.fromMap(
                          ...
                          final provider = context.read<DatabaseProvider>();
                          if (widget.chargement == null) {
                            await provider.ajouterChargement.fromMap(chargement);
                          } else {
                            await provider.modifierChargement.fromMap(chargement);
                          }
