    ...
    return Scaffold(
      ...
      body: Consumer<DatabaseProvider>(
        builder: (context, provider, child) {
          ...
          final List<int> annees = chargementsParAnnee.keys..sort((a, b) => b.compareTo(a));
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              context.read<DatabaseProvider>().supprimerChargement.fromMap(chargement.id!);
