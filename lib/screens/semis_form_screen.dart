            ...
            children: provider.varietes.map((variete) {
              ...
              return FilterChip(
                ...
                onSelected: (selected) {
                  setState(() {
                    if (selected) {
                      _selectedVarietesSurfaces.add(VarieteSurface.fromMap(
                        nom: variete.nom,
                        pourcentage: 0,
                      ));
                    } else {
                ...
                trailing: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (value) {
                      ...
                      setState(() {
                        _selectedVarietesSurfaces[index] = VarieteSurface.fromMap(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          if (widget.semis == null) {
                            await provider.ajouterSemis.fromMap(semis);
                          } else {
                            await provider.modifierSemis.fromMap(semis);
                          }
