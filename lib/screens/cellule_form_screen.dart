                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    try {
                      ...
                      final cellule = Cellule.fromMap(
                        id: widget.cellule?.id,
                        dateCreation: dateCreation,
                      );

                      if (widget.cellule == null) {
                        await context.read<DatabaseProvider>().ajouterCellule.fromMap(cellule);
                      } else {
                        await context.read<DatabaseProvider>().modifierCellule.fromMap(cellule);
                      }
