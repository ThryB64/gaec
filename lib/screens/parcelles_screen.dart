...
class ParcellesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  color: Colors.blue,
                                  onPressed: () => _modifierParcelle.fromMap(context, parcelle),
                                ),
                                IconButton(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _ajouterParcelle.fromMap(context),
        backgroundColor: Colors.green,
  ...
  Future<void> _ajouterParcelle.fromMap(BuildContext context) async {
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                final parcelle = Parcelle.fromMap(
                  nom: nom,
                  surface: surface,
                );
                context.read<DatabaseProvider>().ajouterParcelle.fromMap(parcelle);
  ...
  Future<void> _modifierParcelle.fromMap(BuildContext context, Parcelle parcelle) async {
    final formKey = GlobalKey<FormState>();
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                formKey.currentState!.save();
                final parcelleModifiee = Parcelle.fromMap(
                  id: parcelle.id,
                  nom: nom,
                  surface: surface,
                  dateCreation: parcelle.dateCreation,
                );
                context.read<DatabaseProvider>().modifierParcelle.fromMap(parcelleModifiee);
                Navigator.pop(context);
              }
            },
            style: ElevatedButton.styleFrom(
  ...
  Future<void> _confirmerSuppression(BuildContext context, Parcelle parcelle) async {
    ...
    if (confirmed == true && parcelle.id != null) {
      context.read<DatabaseProvider>().supprimerParcelle.fromMap(parcelle.id!);
    }
  }
} 