class Chargement {
  ...
  @override
  String toString() => 'Chargement.fromMap(id: $id, celluleId: $celluleId, parcelleId: $parcelleId, poidsNet: $_poidsNet, poidsNormes: $_poidsNormes, variete: $variete)';
} 