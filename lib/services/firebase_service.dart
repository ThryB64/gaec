...
class FirebaseService {
  ...
  Future<void> addCellule(Cellule cellule) async {
  ...
  Future<void> addChargement(Chargement chargement) async {
  ...
  Future<void> addSemis(Semis semis) async {
  ...
  Future<void> addVariete(Variete variete) async {
