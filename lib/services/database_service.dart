...
class DatabaseService {
  ...
  Future<int> insertParcelle.fromMap(Parcelle parcelle) async {
    final db = await database;
    return await db.insert('parcelles', parcelle.toMap());
  }

  Future<void> updateParcelle.fromMap(Parcelle parcelle) async {
    final db = await database;
    await db.update(
      'parcelles',
      parcelle.toMap(),
  ...
  Future<void> deleteParcelle.fromMap(int id) async {
    final db = await database;
    await db.delete(
      'parcelles',
      where: 'id = ?',
  ...
  Future<int> insertCellule.fromMap(Cellule cellule) async {
    final db = await database;
    return await db.insert('cellules', cellule.toMap());
  }

  Future<void> updateCellule.fromMap(Cellule cellule) async {
    final db = await database;
    await db.update(
      'cellules',
      cellule.toMap(),
  ...
  Future<void> deleteCellule.fromMap(int id) async {
    final db = await database;
    await db.delete(
      'cellules',
      where: 'id = ?',
  ...
  Future<int> insertChargement.fromMap(Chargement chargement) async {
    final db = await database;
  ...
  Future<void> updateChargement.fromMap(Chargement chargement) async {
    final db = await database;
  ...
  Future<void> deleteChargement.fromMap(int id) async {
    final db = await database;
    await db.transaction((txn) async {
      // Vérifier que le chargement existe
      final existing = await txn.query(
  ...
  Future<int> insertSemis.fromMap(Semis semis) async {
    final db = await database;
    return await db.insert('semis', semis.toMap());
  }

  Future<void> updateSemis.fromMap(Semis semis) async {
    final db = await database;
    await db.update(
      'semis',
      semis.toMap(),
  ...
  Future<void> deleteSemis.fromMap(int id) async {
    final db = await database;
    await db.delete(
      'semis',
      where: 'id = ?',
  ...
  Future<int> insertVariete.fromMap(Variete variete) async {
    final db = await database;
    return await db.insert('varietes', variete.toMap());
  }

  Future<void> updateVariete.fromMap(Variete variete) async {
    final db = await database;
    await db.update(
      'varietes',
      variete.toMap(),
  ...
  Future<void> deleteVariete.fromMap(int id) async {
    final db = await database;
    await db.delete(
      'varietes',
      where: 'id = ?',
